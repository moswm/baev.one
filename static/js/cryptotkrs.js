			...
			if (gethtml == "no") {
				...
				if (pfltickervalues[1]) {
					...
					if (parseFloat(pfltickervalues[4])>parseFloat(pfltickervalues[5])) {
						triangulum="darktriangulumas_b";
					} else {
						triangulum="darktriangulumdes_b";
					}
					var btcusdthl="";
...
testhtml+="<tr><td><b>"+pfltickervalues[0]+"</b></td><td>"+strvalue+"</td><td class=\"hl\">"+resulthtml+"</td><td>"+resulthtml_tr+"</td></tr>";
							}
						}
					}

document.getElementById("test_tickers").innerHTML=testhtml+"</table>";
